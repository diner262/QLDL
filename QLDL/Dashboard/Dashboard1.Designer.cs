...
namespace QLDL
{
    partial class Dashboard1
    {
        ...
        private void InitializeComponent()
        {
            ...
            measure1.DataMember = "STDTra";
            measure1.Name = "Số tiền đã trả(Sum)";
            ...
            this.chartDashboardItem1.DataMember = "tKhach";
            this.chartDashboardItem1.DataSource = this.dashboardSqlDataSource1;
            this.chartDashboardItem1.InteractivityOptions.IgnoreMasterFilters = false;
            this.chartDashboardItem1.Name = "Chart Money Payment";
            ...
            // pieDashboardItem1
            // 
            dimension2.DataMember = "TenTinhThanh";
            ...
            measure2.DataMember = "PhuongTien";
            measure2.Name = "Thống kê phương tiện di chuyển giữa các tỉnh";
            ...
            this.pieDashboardItem1.DataMember = "tKhach";
            ...
            this.pieDashboardItem1.Name = "Pies Vehicle";
            ...
            dimension5.DataMember = "NgayDKy";
            dimension5.DateTimeFormat.YearFormat = DevExpress.DashboardCommon.YearFormat.Full;
            ...
            this.gridDashboardItem1.DataItemRepository.Add(dimension7, "DataItem4");
            this.gridDashboardItem1.DataMember = "tKhach";
            ...
            this.gridDashboardItem1.Name = "Grid Register";
            this.gridDashboardItem1.ShowCaption = true;
            // 
            // dashboardSqlDataSource1
            // 
            this.dashboardSqlDataSource1.ComponentName = "dashboardSqlDataSource1";
            this.dashboardSqlDataSource1.ConnectionName = "localhost_QLDKDULICH_Connection";
            msSqlConnectionParameters1.AuthorizationType = DevExpress.DataAccess.ConnectionParameters.MsSqlAuthorizationType.Windows;
            msSqlConnectionParameters1.DatabaseName = "QLDKDULICH";
            msSqlConnectionParameters1.ServerName = "MSI-BRAVO-15\\SQLEXPRESS01";
            ...
            columnExpression1.ColumnName = "TenKhach";
            table1.MetaSerializable = "<Meta X=\"30\" Y=\"30\" Width=\"125\" Height=\"186\" />";
            table1.Name = "tKhach";
            columnExpression1.Table = table1;
            column1.Expression = columnExpression1;
            columnExpression2.ColumnName = "MaKhach";
            columnExpression2.Table = table1;
            column2.Expression = columnExpression2;
            columnExpression3.ColumnName = "NgayDKy";
            table2.MetaSerializable = "<Meta X=\"185\" Y=\"30\" Width=\"125\" Height=\"165\" />";
            table2.Name = "tDangKy";
            columnExpression3.Table = table2;
            column3.Expression = columnExpression3;
            columnExpression4.ColumnName = "STDTra";
            columnExpression4.Table = table2;
            column4.Expression = columnExpression4;
            columnExpression5.ColumnName = "PhuongTien";
            table3.MetaSerializable = "<Meta X=\"340\" Y=\"30\" Width=\"125\" Height=\"186\" />";
            table3.Name = "tChuyenDuLich";
            columnExpression5.Table = table3;
            column5.Expression = columnExpression5;
            columnExpression6.ColumnName = "DonGia";
            columnExpression6.Table = table3;
            column6.Expression = columnExpression6;
            columnExpression7.ColumnName = "TenDD";
            table4.MetaSerializable = "<Meta X=\"650\" Y=\"30\" Width=\"125\" Height=\"144\" />";
            table4.Name = "tDiaDiemThamQuan";
            columnExpression7.Table = table4;
            column7.Expression = columnExpression7;
            columnExpression8.ColumnName = "TenTinhThanh";
            ...
            selectQuery1.Name = "tKhach";
            relationColumnInfo1.NestedKeyColumn = "MaKhach";
            relationColumnInfo1.ParentKeyColumn = "MaKhach";
            join1.KeyColumns.Add(relationColumnInfo1);
            join1.Nested = table2;
            join1.Parent = table1;
            relationColumnInfo2.NestedKeyColumn = "MaChuyen";
            relationColumnInfo2.ParentKeyColumn = "MaChuyen";
            join2.KeyColumns.Add(relationColumnInfo2);
            join2.Nested = table3;
            join2.Parent = table2;
            relationColumnInfo3.NestedKeyColumn = "MaChuyen";
            relationColumnInfo3.ParentKeyColumn = "MaChuyen";
            join3.KeyColumns.Add(relationColumnInfo3);
            table5.MetaSerializable = "<Meta X=\"495\" Y=\"30\" Width=\"125\" Height=\"123\" />";
            table5.Name = "tChiTietTuyenDuLich";
            join3.Nested = table5;
            join3.Parent = table3;
            relationColumnInfo4.NestedKeyColumn = "MaDD";
            relationColumnInfo4.ParentKeyColumn = "MaDD";
            join4.KeyColumns.Add(relationColumnInfo4);
            join4.Nested = table4;
            join4.Parent = table5;
            relationColumnInfo5.NestedKeyColumn = "MaTuyen";
            relationColumnInfo5.ParentKeyColumn = "MaTuyen";
            join5.KeyColumns.Add(relationColumnInfo5);
            table6.MetaSerializable = "<Meta X=\"805\" Y=\"30\" Width=\"125\" Height=\"165\" />";
            table6.Name = "tTuyen";
            join5.Nested = table6;
            join5.Parent = table3;
            ...
            dashboardLayoutItem2.Weight = 49.951124144672534D;
            dashboardLayoutItem3.DashboardItem = this.pieDashboardItem1;
            dashboardLayoutItem3.Weight = 50.048875855327466D;
